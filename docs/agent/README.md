...
| Raw HTTP Agent / integrator | Claim, resume, request and retry | [Kit README](http-kit/README.md), [boundary](http-kit/AGENTS.md), [session workflow](http-kit/skills/icm-circuit-session/SKILL.md), published OpenAPI | [API examples](api-usage.md), common knowledge | `GET /api/agent/kit` |
