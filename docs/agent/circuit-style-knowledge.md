...
- Use the right-tapered transconductance block from Analog Blocks for `g_m`
  relations. Keep A-to-Y flow left-to-right and edit its formula rather than
  treating it as a transistor or an automatic SPICE mapping.
