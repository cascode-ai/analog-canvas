...
| Analog simulation: Cell reuse, Testbench, OP, AC, TRAN, raw SPICE | structured OP/AC Preview baseline implemented; human workspace convergence proposed; v13 remains the latest full-scope handoff | [Simulation Workspace UX v1](simulation-workspace-ux-plan-v1.md) and [full-scope vertical integration plan](simulation-vertical-integration-plan-v13.md) |
