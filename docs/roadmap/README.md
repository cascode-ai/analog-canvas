...
| Analog simulation: Cell reuse, Testbench, OP, AC, TRAN, raw SPICE | v4 discussion plan; proposed work pending | [v4 vertical integration plan and Fable handoff](simulation-vertical-integration-plan-v4.md); [retained v3](simulation-vertical-integration-plan-v3.md); [retained v2](simulation-vertical-integration-plan-v2.md); [retained v1](simulation-vertical-integration-plan.md) |
