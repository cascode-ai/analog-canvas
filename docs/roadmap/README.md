...
| Analog simulation: Testbench, OP, and AC               | v1 discussion draft; proposed work pending                    | [vertical integration plan and Fable handoff](simulation-vertical-integration-plan.md)                                  |
