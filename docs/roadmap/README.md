...
| Analog simulation: Cell reuse, Testbench, OP, AC, TRAN, raw SPICE | v13 current discussion plan; resilient failures and Coding Agent delivery acceptance added | [current vertical integration plan](simulation-vertical-integration-plan-v13.md) |
