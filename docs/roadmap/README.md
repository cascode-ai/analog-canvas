...
| VACASK migration                  | Native simulator replacement, isolated branch qualification, preserved interaction and one-candidate acceptance                                     | [VACASK migration](vacask-migration.md)                                                |
