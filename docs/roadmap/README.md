...
| Analog simulation: Cell reuse, Testbench, OP, AC, TRAN, raw SPICE | v3 discussion plan; proposed work pending | [v3 vertical integration plan and Fable handoff](simulation-vertical-integration-plan-v3.md); [retained v2](simulation-vertical-integration-plan-v2.md); [retained v1](simulation-vertical-integration-plan.md) |
