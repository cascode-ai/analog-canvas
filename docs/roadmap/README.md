...
| Analog simulation: Testbench, OP, AC, TRAN, raw SPICE   | v2 discussion plan; proposed work pending                     | [v2 vertical integration plan and Fable handoff](simulation-vertical-integration-plan-v2.md); [retained v1](simulation-vertical-integration-plan.md) |
