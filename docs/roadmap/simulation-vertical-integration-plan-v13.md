...
- cloud / local execution：[Worker simulation route](../../worker/simulation.ts)、[Agent session runtime](../../worker/agent-session-runtime.ts)、[ngspice image](../../containers/ngspice/Dockerfile)、[container entrypoint](../../containers/ngspice/entrypoint.mjs)、[local host](https://github.com/cascode-ai/analog-canvas/blob/4710802971107c080d00f3be40693ad6d8a4648f/apps/local-host/src/simulate.ts)
