...
| [`simulation.md`](simulation.md)                               | accepted        | Saved source folders, Testbench roots, circuit ownership, and compilation                |
| [`simulation-code-workspace.md`](simulation-code-workspace.md) | accepted        | Source folders, mapped parameter edits, drafts, language assistance, and Code dock         |
