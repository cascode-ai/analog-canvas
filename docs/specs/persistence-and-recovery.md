...
Project content uses canonical schema-50 JSON. A private Cloud Project is the
...
complete schema-50 Project or a supported historical record that validates
