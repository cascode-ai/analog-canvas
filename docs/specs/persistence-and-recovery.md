...
Project content uses canonical schema-46 JSON. A private Cloud Project is the
...
before import or Cloud Save. The explicit schema 24→46 chain upgrades supported
historical files; serialization always writes schema 46. The 32→33 adapter
...
complete schema-46 Project or a supported historical record that validates
