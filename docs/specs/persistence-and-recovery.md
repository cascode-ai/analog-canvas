...
Project content uses canonical schema-48 JSON. A private Cloud Project is the
...
complete schema-48 Project or a supported historical record that validates
