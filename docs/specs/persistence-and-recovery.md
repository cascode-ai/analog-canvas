...
Project content uses canonical schema-53 JSON. A private Cloud Project is the
...
before import or Cloud Save. The explicit schema 24→53 chain upgrades supported
historical files; serialization always writes schema 53. The 32→33 adapter
...
complete schema-53 Project or a supported historical record that validates
