...
Project content uses canonical schema-49 JSON. A private Cloud Project is the
...
historical files; serialization always writes schema 49. The 32→33 adapter
...
select a device or analysis implicitly.
...
complete schema-49 Project or a supported historical record that validates
