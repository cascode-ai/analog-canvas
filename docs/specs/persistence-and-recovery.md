...
Project content uses canonical schema-47 JSON. A private Cloud Project is the
...
complete schema-47 Project or a supported historical record that validates
