...
Project content uses canonical schema-45 JSON. A private Cloud Project is the
...
before import or Cloud Save. The explicit schema 24→45 chain upgrades supported
historical files; serialization always writes schema 45. The 32→33 adapter
...
complete schema-45 Project or a supported historical record that validates
