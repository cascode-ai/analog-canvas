...
Project content uses canonical schema-62 JSON. A private Cloud Project is the
...
complete schema-62 Project or a supported historical record that validates
