...
Project content uses canonical schema-61 JSON. A private Cloud Project is the
...
complete schema-61 Project or a supported historical record that validates
