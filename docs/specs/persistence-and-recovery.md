...
Project content uses canonical schema-42 JSON. A private Cloud Project is the
...
before import or Cloud Save. The explicit schema 24→42 chain upgrades supported
historical files; serialization always writes schema 42. The 32→33 adapter
...
complete schema-42 Project or a supported historical record that validates
