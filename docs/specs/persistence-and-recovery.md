...
Project content uses canonical schema-41 JSON. A private Cloud Project is the
...
before import or Cloud Save. The explicit schema 24→41 chain upgrades supported
historical files; serialization always writes schema 41. The 32→33 adapter
...
complete schema-41 Project or a supported historical record that validates
