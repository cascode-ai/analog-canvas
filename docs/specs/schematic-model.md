...
geometric, and presentation facts. The current model is strict schema 48 and has
...
Persistence writes only schema 48. The reader carries every schema in its
