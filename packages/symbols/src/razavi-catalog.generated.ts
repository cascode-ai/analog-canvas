...
export const razaviSymbolCatalogEntries: readonly RazaviSymbolCatalogEntry[] = [
  ...
  },
  {
    ...
    palette: true,
    automaticMappings: [],
    assetPath: "capacitor-section.json",
    assetHash:
      "571a42e3c244a6ea10345b5a9c714b9eb3f57dc4a381519faef7fb739cea7410",
    visualAuthority: {
      kind: "razavi-reference-v1",
      referenceManifestPath:
        "fixtures/visual-reference/razavi-reference-v1/manifest.json",
      referencePaths: [
        ...
        "fixtures/visual-reference/razavi-reference-v1/capacitor-section-reference.png",
      ],
      calibrationPath:
        "fixtures/visual-reference/razavi-reference-v1/capacitor-section-vector-source.json",
    },
